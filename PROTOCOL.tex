...
eight samples; the exact McNemar tests in the paper's closed-loop table
(Table~II) instead
...
The paper's external-validity subsection (\S VI-G) states the outcome of
these three robustness checks; this is each of them in full.
...
The headline quantities of the paper's evaluation (\S VI) are collected in a
